    ...
    public class Seed
    {
        public static async Task SeedData(DataContext context, UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            if (!userManager.Users.Any() && !context.Movies.Any() && !roleManager.Roles.Any())
            {
                ...
                {
                    new AppUser{DisplayName = "Doruntina", IsAdmin=true, UserName= "Doruntina", Email = "dk40651@ubt-uni.net", },
                    new AppUser{DisplayName = "Rina", IsAdmin=false,UserName = "Rina", Email = "rk48713@ubt-uni.net"},
                    new AppUser{DisplayName = "Doruntina2", IsAdmin=false, UserName = "Doruntina2", Email = "doruntinekorca@gmail.com"},
                    new AppUser{DisplayName = "Tina", IsAdmin=false, UserName = "DoruntinaTina", Email = "tinnakorqa@gmail.com"},
                    new AppUser{DisplayName = "Alea", IsAdmin=false, UserName = "Aleaaa", Email = "aleakorqa@gmail.com"},
                    };
